 ...
 * @author Francisco
 */
public class CombosDEV extends javax.swing.JFrame {
    
    DefaultTableModel modeloTab = new DefaultTableModel();    
    
    /**
     * Creates new form CombosDEV
     */
    public CombosDEV() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CombosDEV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
